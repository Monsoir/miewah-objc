...
@implementation LongItemTableViewCell
...
- (void)roundContainer {
    ...
    [self.lbItem maskRoundedCorners:UIRectCornerTopLeft | UIRectCornerTopLeft cornerRadius:CGSizeMake(cornerRadius, cornerRadius)];
}
