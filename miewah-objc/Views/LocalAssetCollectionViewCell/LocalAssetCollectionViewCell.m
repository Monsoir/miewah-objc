//
//  LocalAssetCollectionViewCell.m
//  miewah-objc
//
...
@interface LocalAssetCollectionViewCell()
...
@implementation LocalAssetCollectionViewCell
...
+ (CGFloat)cellWidth {
    return [UIConstants screenWidth] - 40;
}
...
- (void)layoutSubviews {
    ...
    [self layoutIfNeeded]; // 避免 cell 出现时，分割线长度不正确
